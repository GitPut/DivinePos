...
import { ProductProp, StockHistoryEntry } from "types";
import { fetchStockHistory } from "services/firebase/functions";
...
function StockHistoryModal({ product, onClose }: StockHistoryModalProps) {
  ...
  const formatDate = (entry: StockHistoryEntry) => {
    try {
        ...
        <div style={styles.tableWrapper}>
          {loading ? (
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {history.map((entry) => {
                  const colors = typeColors[entry.type] ?? typeColors.adjustment;
                  return (
                    <tr key={entry.id}>
                      ...
                      <td style={styles.td}>{entry.quantityBefore}</td>
                      <td style={styles.td}>{entry.quantityAfter}</td>
